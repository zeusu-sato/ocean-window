...
const report = { platform: process.platform, architecture: process.arch, channel, metadata, extensionVersion: version, vsixSha256: expected, appRoot, executable, vsix, output };
