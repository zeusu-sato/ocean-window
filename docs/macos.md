...
The exact published 0.3.0 VSIX then passed those same four combinations and restart checks: [published-package Mac run](https://github.com/zeusu-sato/ocean-window/actions/runs/33971360461/attempts/2). All four reports matched the release checksum and confirmed unchanged native files.
